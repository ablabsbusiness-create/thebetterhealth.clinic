...
const generatorScript = resolve(appDir, 'scripts', 'generate_minimal_iap_pngs.py');
const whoGeneratorScript = resolve(appDir, 'scripts', 'generate_official_who_pngs.py');
...
function runWhoGenerator() {
  if (!existsSync(whoGeneratorScript)) {
    return false;
  }
