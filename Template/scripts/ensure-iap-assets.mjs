...
const generatorScript = resolve(import.meta.dirname, 'generate_minimal_iap_pngs.py');
const whoGeneratorScript = resolve(import.meta.dirname, 'generate_official_who_pngs.py');
